...
<script type="text/javascript">
    ...
    '<div id="alert-ie">'+
		'<div>'+
			'<span class="h2">Attention, vous utilisez un navigateur obsol&egrave;te</h2> <br>'+
			'<p>'+
...
\*------------------------------------*/
	...
	// si on est sur "safari 7-" ou 	// si on est sur "internet" navigateur defaut android
	if(oldSafariBrowser || isAndroidBrowser){
		document.write(alertIeDiv);
	}
</script>

<!--[if (lte IE 9)]><script type="text/javascript">document.write(alertIeDiv);</script><![endif]-->